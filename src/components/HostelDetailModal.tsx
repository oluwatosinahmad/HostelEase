              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3 text-xs text-slate-600 flex-wrap">
                  ...
                  {onViewOnMap && (
                    <button
                      type="button"
                      onClick={() => onViewOnMap(`${property.address}, ${property.area.name}`)}
                      className="px-2.5 py-1 bg-blue-50 hover:bg-blue-100 text-blue-700 font-bold text-xs rounded-lg border border-blue-200 transition-colors flex items-center gap-1 cursor-pointer"
                      title="View this house on Google Map and get live directions"
                    >
