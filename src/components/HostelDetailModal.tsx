                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        {onOpenConversation && (
                          <button
                            ...
                            className="px-3.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl flex items-center gap-1.5 shadow-sm transition-colors"
                          >
                            <MessageSquare className="w-3.5 h-3.5" />
                            Message {property.provider.name.split(' ')[0]}
                          </button>
                        )}
